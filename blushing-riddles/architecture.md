...
The UI should be deliberately minimalist (Option B design):
- text-only badges and minimal decorative icons
- no emojis or sparkles
- front: riddle text
- back: answer
- simple tap or click to reveal
- solid, clean background instead of gradients
- simple fade or text morph animation on reveal

The most important interaction is the reveal moment, so the UI should prioritize clarity and clean typography over visual complexity. Let the suggestive copy carry the weight.
