...
- [ ] Write a short content policy for suggestive-but-clean riddles
- [ ] Define the review rubric for approved / needs-edit / rejected
- [ ] Create the first 25 suggestive, "dirty mind" seed riddles by hand or with AI + review
- [ ] Decide the supported topic categories

## Phase 2 — SvelteKit foundation

- [ ] Create the SvelteKit app structure
- [ ] Add Tailwind styling with a strict minimalist aesthetic (Option B: no emojis, no sparkles)
- [ ] Build the clean reveal interaction component (fade or morph, no flip/particles)
